...
class BaseOptions:
    ...
    def gather_options(self, input_opts=None):
        ...
        if not input_opts:
            ...
            opt, unknown = parser.parse_known_args(input_opts)
    ...
    def parse(self, save=False, input_opts=None):

        opt = self.gather_options(input_opts)
